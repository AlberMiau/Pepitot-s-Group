...
<div class="row">
  <div class="twelve columns">
    <h2>Welcome to XAMPP for Windows 7.2.4</h2>
  </div>
</div>
<div class="row">
  <div class="twelve columns">
    <p class="enlace_index">
      You have successfully installed XAMPP on this system! Now you can start using Apache, MariaDB, PHP and other components.
      You can find more info in the <a href="pagina3.php">HOW-TO Guides</a> for getting started with PHP applications.
    ...
    <p class="enlace_index">
      ...
      If you want have your XAMPP accessible from the internet, make sure you understand the implications and you checked the <a href="pagina2.php">FAQs</a> to learn how to protect your site. Alternatively you can use <a href="https://bitnami.com/stack/wamp">WAMP</a>, <a href="https://bitnami.com/stack/mamp">MAMP</a> or <a href="https://bitnami.com/stack/lamp">LAMP</a> which are similar packages which are more suitable for production.
    </p>
    <p>
...
<div class="row">
  <div class="twelve columns">
    <h3 class="enlace_index">Contribute to XAMPP translation at <a href="https://translate.apachefriends.org/">translate.apachefriends.org</a>.</h3>
  </div>
</div>
<div class="row">
  <div class="twelve columns">
...
<div class="row">
  <div class="twelve columns">
    <a href="http://bitnami.com/stack/xampp?utm_source=bitnami&amp;utm_medium=installer&amp;utm_campaign=XAMPP%2BModule" target="_blank"><img alt="Bitnami XAMPP page" src="img/bitnami-xampp.png"></a>
  </div>
</div>
